...
--
-- Host: localhost    Database: geekmitive
-- ------------------------------------------------------
...
CREATE TABLE `carrito` (
  ...
  KEY `FKsbqpxk63xrpyck17xawl195dt` (`id_usuario`),
  CONSTRAINT `FKsbqpxk63xrpyck17xawl195dt` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
...
CREATE TABLE `delivery` (
  `id_shopping_order` bigint NOT NULL AUTO_INCREMENT,
  `cantidad_producto` int DEFAULT NULL,
  `id_producto` bigint DEFAULT NULL,
  `subtotal_producto` double DEFAULT NULL,
  PRIMARY KEY (`id_shopping_order`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shopping_order` (
  `id_shopingorder` bigint NOT NULL AUTO_INCREMENT,
  `id_usuario` int DEFAULT NULL,
  `monto_total` double DEFAULT NULL,
  PRIMARY KEY (`id_shopingorder`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'geekmitive'
--
...
-- Dump completed on 2022-11-12 15:53:52
